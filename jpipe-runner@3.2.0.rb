...
class JpipeRunnerAT320 < Formula
    include Language::Python::Virtualenv

    homepage "https://github.com/jpipe-mcscert/jpipe-runner"
    url "https://github.com/jpipe-mcscert/jpipe-runner/releases/download/v3.2.0/jpipe_runner-3.2.0.tar.gz"
    sha256 "dd1f5b6bb4713bd87f7b1d1e33df10d9e93608d0830818ab77e955b41bf4e4dc"
